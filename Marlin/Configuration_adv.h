 ...
 */
#define E0_AUTO_FAN_PIN -1 // Turn off extruder fan when its temperature is above 50°C
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.22        // Kossel Delta Advance_K 0.22(mm) Compression length applying to all extruders
  #endif
